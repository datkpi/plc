           ...
           <div class="row">
                   ...
                   <div class="form-group">
                       ...
                       <select class="form-control select2" name="product_code" required>
                           ...
                           @foreach($products as $product)
                               <option value="{{ $product->code }}" {{ old('product_code', $entry->product_code) == $product->code ? 'selected' : '' }}>
                                   {{ $product->code }}
                               </option>
                           @endforeach
                       </select>
               ...
               <div class="col-md-6">
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="operator_team" value="{{ old('operator_team', $entry->operator_team) }}" required>
                   </div>
               </div>
               <div class="col-md-6">
               <div class="form-group">
                ...
                <input type="text" class="form-control" name="operator_name"
                       value={{ old('operator_name', $entry->operator_name) }}" required>
                </div>
               </div>
           </div>
           ...
           <div class="row">
               <div class="col-md-4">
                   <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="machine_operator" value="{{ old('machine_operator', $entry->machine_operator) }}" required>
                   </div>
               </div>
               <div class="col-md-4">
                   <div class="form-group">
                       <label>CN kiểm <span class="text-danger">*</span></label>
                       <input type="text" class="form-control" name="quality_checker" value="{{ old('quality_checker', $entry->quality_checker) }}" required>
                   </div>
               </div>
               <div class="col-md-4">
                   <div class="form-group">
                       <label>CN kho <span class="text-danger">*</span></label>
                       <input type="text" class="form-control" name="warehouse_staff" value="{{ old('warehouse_staff', $entry->warehouse_staff) }}" required>
                   </div>
               </div>
           </div>
