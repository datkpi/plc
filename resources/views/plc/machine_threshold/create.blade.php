    ...
    <div class="card-body">
        ...
        <form action="{{ route('plc.machine.thresholds.store') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="color" name="color" class="form-control" value="{{ old('color', '#0000ff') }}" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select name="type" class="form-control" required onchange="toggleInputs(this.value)">
                    ...
                    <option value="range" {{ old('type') == 'range' ? 'selected' : '' }}>Khoảng Min-Max</option>
                    <option value="percent" {{ old('type') == 'percent' ? 'selected' : '' }}>Theo % dao động</option>
                    <option value="avg" {{ old('type') == 'avg' ? 'selected' : '' }}>Trung bình 10 phút</option>
                </select>
            </div>
            ...
            <div id="boolean_inputs" class="type-inputs">
                <div class="form-group mb-3">
                    ...
                    <select name="boolean_value" class="form-control">
                        <option value="1" {{ old('boolean_value') == '1' ? 'selected' : '' }}>
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('plc.machine.thresholds.show', request()->machine_id) }}" class="btn btn-secondary">
...
function toggleInputs(type) {
    ...
    // Reset other inputs
    $('.type-inputs:not(#' + type + '_inputs) input').val('');
}
...
$(document).ready(function() {
    ...
    toggleInputs($('select[name="type"]').val() || 'boolean');
