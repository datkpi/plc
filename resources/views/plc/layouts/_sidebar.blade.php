    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('plc.products.index') }}" class="nav-link">
                        <i class="fas fa-boxes nav-icon"></i>
                        <p>Quản lý sản phẩm</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('plc.materials.index') }}" class="nav-link">
                        <i class="fas fa-cube nav-icon"></i>
                        <p>Quản lý nguyên liệu</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('plc.pe_standards.index') }}" class="nav-link">
                        <i class="fas fa-ruler nav-icon"></i>
                        <p>Tiêu chuẩn cuộn PE</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('plc.data.monitor', ['machine_id' => 1]) }}" class="nav-link">
                        <i class="fas fa-desktop nav-icon"></i>
                        <p>Giám sát thông số</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('plc.alert.index') }}" class="nav-link">
                        <i class="fa fa-exclamation-triangle nav-icon"></i>
                        <p>Cảnh báo hệ thống</p>
                    </a>
                </li>

                <li class="nav-header">Dữ liệu sản xuất</li>
                <li class="nav-item">
                    <a href="{{ route('plc.production.entries.index') }}" class="nav-link">
                        <i class="fas fa-clipboard-list nav-icon"></i>
                        <p>Nhập liệu sản xuất</p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('plc.reports.oee.daily') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Theo ngày</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('plc.reports.oee.monthly') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Theo tháng</p>
                            </a>
                        </li>
